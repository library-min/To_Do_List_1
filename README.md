깃허브 프로젝트 리드미인데 # 📋 Smart Todo - 고급 할 일 관리 애플리케이션
...
- **확장 레이아웃**: 1200px 최대 너비로 화면 공간 최적 활용

- **모던 버튼 디자인**: 그라데이션 배경과 부드러운 호버 애니메이션

- **인터랙티브 요소**: 카드 호버 시 lift 효과와 색상 변화

- **상단 네비게이션**: 고정 헤더에 앱 제목과 테마 토글 배치
...
- **Modern Design System** - 1200px 와이드 레이아웃, 그라데이션 버튼, 카드 호버 효과
